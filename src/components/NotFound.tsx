  ...
  return (
    <div className="min-h-screen bg-bg text-text flex items-center justify-center relative overflow-hidden">
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        ...
        <div className="absolute top-1/4 left-1/3 w-96 h-96 bg-error/20 rounded-full mix-blend-screen filter blur-3xl animate-pulse"></div>
        <div className="absolute bottom-1/3 right-1/4 w-96 h-96 bg-brand/20 rounded-full mix-blend-screen filter blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
        <div className="bg-surface/80 backdrop-blur-xl rounded-3xl shadow-lg border border-border p-12 md:p-16 text-center">
          <div className="mb-8 relative">
            <div className="absolute inset-0 bg-gradient-to-r from-error via-brand to-brand-pressed blur-3xl opacity-30 animate-pulse"></div>
            <h1 className="text-9xl md:text-[12rem] font-black font-mono bg-gradient-to-r from-error via-brand to-brand-pressed bg-clip-text text-transparent relative drop-shadow-2xl">
              404
            </h1>
          </div>
          ...
          <div className="bg-error/10 border border-error/30 rounded-2xl p-6 mb-12 backdrop-blur-sm">
            <div className="flex items-start gap-4">
              ...
              <div className="text-left flex-1">
                <h3 className="text-xl font-bold text-text-hi mb-2">Lost in the automaton?</h3>
          ...
          <Link
            to="/"
            className="inline-flex items-center gap-2 min-h-[44px] px-8 py-3 bg-brand text-on-brand rounded-xl font-semibold transition-all hover:bg-brand-hover active:scale-95"
          >
          ...
          <div className="mt-12 flex justify-center items-center gap-3">
            ...
            <div className="w-2 h-2 rounded-full bg-brand animate-pulse" style={{ animationDelay: '0.3s' }}></div>
