...
// PumpingControls: prev / next / play-pause / speed controls for the pumping
// lemma view. Copied near-verbatim from EliminationControls (src/components/n2r/)
// with renamed data-testids (pumping-prev / pumping-next / pumping-play). See that
// file for the shape rationale.
//
  ...
  return (
    <div className="flex flex-wrap items-center gap-3">
      ...
      <button
        ...
        aria-label="Previous pumping stage"
        data-testid="pumping-prev"
      >
      ...
      {!reducedMotion && (
        <button
          ...
          aria-label={isPlaying ? 'Pause pumping walkthrough' : 'Play pumping walkthrough'}
          data-testid="pumping-play"
        >
          {isPlaying ? (
            <>
      ...
      <button
        ...
        className={secondaryBtnClass}
        title="Next stage"
        aria-label="Next pumping stage"
        data-testid="pumping-next"
      >
      ...
      {!reducedMotion && (
        <div className="flex items-center gap-2 ml-2 px-4 min-h-[44px] bg-surface-raised rounded-lg border border-border">
          ...
          <select
            ...
            title="Pumping animation speed"
            aria-label="Pumping walkthrough animation speed"
          >
