...
import { patternTemplates, getTemplateById, PatternTemplate } from '@/core/patterns/templates'

interface PatternBuilderProps {
  onInsert: (regex: string) => void
}

export function PatternBuilder({ onInsert }: PatternBuilderProps) {
