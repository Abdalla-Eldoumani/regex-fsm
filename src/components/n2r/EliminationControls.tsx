...
// EliminationControls: prev / next / play-pause / speed controls for the
// NFA-to-regex elimination view.
//
// Mirrors the SimulationControls shape: secondaryBtnClass (min-h-[44px]),
// brand-fill Play/Pause, speed select with 0.5x/1x/2x/4x options.
//
...
export function EliminationControls({
  currentStep,
  totalSteps,
  isPlaying,
  speed,
  ...
  return (
    <div className="flex flex-wrap items-center gap-3">
      ...
      <button
        ...
        title="Previous step"
        aria-label="Previous elimination step"
        data-testid="n2r-prev"
      >
      ...
      {!reducedMotion && (
        <button
          ...
          aria-label={isPlaying ? 'Pause elimination' : 'Play elimination'}
          data-testid="n2r-play"
        >
          {isPlaying ? (
            <>
      ...
      <button
        ...
        className={secondaryBtnClass}
        title="Next step"
        aria-label="Next elimination step"
        data-testid="n2r-next"
      >
